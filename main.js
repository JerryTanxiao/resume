const projectData = {
    ...
    'dow': {
        ...
        desc: `自主研发的高性能机器人集成框架，具备双协议长连接与多模态交互能力。实现全自动智能运营。<br><br>
               ...
               • 基于 FFmpeg 实现语音消息自动识别与 TTS 情感化答复。`
    },
    'mangaflow': {
        title: '小说/动漫分镜全流程助手',
        tech: 'React 19 / TypeScript / Google Gemini SDK / AIGC / Tailwind CSS',
        desc: `针对漫剧（Manga-Drama）生产设计的全链路 AIGC 工业化助手。实现从灵感文本向制作级视觉描述全自动流转。<br><br>
               <strong>核心亮点：</strong><br>
               • 构建从「灵感 -> 小说 -> 脚本 -> 分镜」的生成闭环，支持场景、动作与对白的智能提取。<br>
               • 自研 8 维度结构化提示词引擎，支持专业景别、镜头运用等工业化指令输出。<br>
               • 锁定角色一致性特征并输出不同艺术风格（电影感、水墨、霓虹等）的视觉指令。`
    },
    'kkb': {
        title: '客客帮 —— 话费权益订单全链路风控系统',
        tech: 'Java 17 / Spring Cloud / MySQL / MyBatis-Plus / Dynamic-Datasource',
        desc: `支撑千万级话费/权益卡代充业务的全链路风控，保障平台交易安全。<br><br>
               ...
               • **性能优化**：通过多级缓存与 SQL 执行计划调优，提升风控校验性能 60%。`
    },
    'zhongtai': {
        title: '深能环保数智中台 (数智中心)',
        tech: 'Flink / MySQL 物理优化 / DataWorks / 实时计算',
    ...
    'wuwei': {
        ...
        tech: 'RocketMQ 源码 / 时间轮算法 / 微服务治理 / 10w+ 直播架构',
    ...
    'xiudian': {
        ...
        desc: `主导千万级 MQ 轨迹积压治理与高并发 IoT 位置服务架构。<br><br>
               ...
               • 基于 Netty + Protobuf 压缩 70% 带宽，引入经纬度平滑纠偏算法将轨迹误差控制在米级。`
    }
};
