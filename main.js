const projectData = {
    'ddms': {
        ...
        desc: `面向同城即时配送的 AI 驱动多租户 SaaS 平台，已覆盖 180+ 区域代理商，集成京东、美团订单分发，日订单规模 10w+。<br><br>
               ...
               • **复杂代理结算机制**：主导 180+ 区域代理商的分布式结账系统，利用 Seata 保障跨租户、跨账期的财务对账零误差。`
    },
    'dow': {
        title: 'DOW 供应链智能助手框架 (AI 核心研发)',
        tech: 'Python / FastAPI / Dify Agent / PAD Protocol / Redis / FFmpeg / Docker',
        desc: `自主研发的高性能机器人集成框架，具备双协议长连接与多模态交互能力。实现全自动智能运营。<br><br>
               ...
               • **多模态消息处理**：基于 FFmpeg 实现语音消息自动识别与 TTS 情感化答复；支持图文多轮对话理解。`
    },
    'mangaflow': {
    ...
    'zhongtai': {
        ...
        desc: `WIS 交易/分析数据分离及全量流批一体计算底座建设，聚焦指标定义与实时计算看板。<br><br>
               ...
               • **MySQL 物理计划优化**：深度优化 SQL 执行计划，将 300s 慢查询由降至 1s。`
    },
    'wuwei': {
        ...
        desc: `支撑 10w+ 在线直播的高并发教育平台，保障 1 亿级营收业务稳定性。<br><br>
               ...
               • **架构治理**：主导单体向微服务剥离，实现小程序到支付的自动化平滑切换。`
    },
    'xiudian': {
